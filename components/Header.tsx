      ...
      <div className="mx-auto max-w-6xl overflow-visible rounded-2xl border border-white/10 bg-pine-950/85 shadow-[0_16px_48px_rgba(10,31,21,0.45)] backdrop-blur-xl">
        ...
        <div className="flex h-16 items-center justify-between gap-4 px-4 sm:px-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/strefa-6sp"
              className="animate-pulse-soft group inline-flex items-center gap-1.5 rounded-xl border-2 border-toxic bg-blood px-3 py-1.5 text-xs font-extrabold uppercase tracking-wide text-white shadow-[0_4px_0_0_var(--color-blood-dark),0_8px_18px_rgba(209,31,42,0.45)] transition-all duration-150 hover:-translate-y-0.5 hover:bg-blood-dark hover:shadow-[0_6px_0_0_var(--color-blood-dark),0_10px_22px_rgba(209,31,42,0.5)] active:translate-y-1 active:shadow-[0_0_0_0_var(--color-blood-dark)] md:gap-2 md:px-4 md:py-2"
            >
